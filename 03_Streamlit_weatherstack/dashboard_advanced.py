...
with tab1:
    ...
    registros_actuales = (
        ...
        .join(subq, RegistroClima.ciudad_id == subq.c.ciudad_id)
        .join(Ciudad, Ciudad.id == RegistroClima.ciudad_id)
        .filter(RegistroClima.fecha_extraccion == subq.c.max_fecha)
        .all()
    )

    # ✅ DataFrame (SIN indent extra)
